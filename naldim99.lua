...
local IDIOMA = "PT-BR" -- Altere para "EN" para inglês / Change to "EN" for English
        ...
        local Services = setmetatable({}, {
            __index = function(self, key)
                ...
                if suc and service then
                    ...
                    warn(`[Services] Aviso / Warning: "{key}" é inválido / is not a valid Roblox service.`)
                    return nil
                end
            end
        })
